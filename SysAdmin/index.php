                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">User Activity Dash Board </h2>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php
                                                ...
                                                $count_user=mysqli_num_rows($query_exe);
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Female Users</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Male Users</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Staff User</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1">
                                                <h1 class="mb-1"><?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="m-r-10"><img
                                                                    src="../img/user/<?php echo $image;?>" alt="user"
